 ...
 *
 * @author Matt Day
 * @see EditMembershipTask
 */
@PersistenceCapable(detachable = "true", table = "Spark_edit_membership")
public class EditMembershipConfig implements TaskConfigIf {
