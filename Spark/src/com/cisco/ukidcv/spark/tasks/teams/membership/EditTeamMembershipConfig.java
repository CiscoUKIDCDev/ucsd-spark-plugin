...
/**
 * Configuration task to edit a Spark membership. This task uses the email
 * address and team ID to remove a user as UCSD cannot cache every user in
 * spark.
 * <p>
 * The execution task will look up the membership ID to edit the member
 * <p>
 ...
 *
 * @author Matt Day
 * @see EditTeamMembershipTask
 */
@PersistenceCapable(detachable = "true", table = "Spark_edit_team_membership")
public class EditTeamMembershipConfig implements TaskConfigIf {
	 ...
	 * you wanted
	 */
	public EditTeamMembershipConfig() {
		super();
