...
import com.cisco.ukidcv.spark.tasks.rooms.EditRoomConfig;
...
/**
 * Action button allowing the user to edit an existing room
 *
 * @author Matt Day
 * @see SparkRoomReport
 * @see EditRoomConfig
 *
 */
public class EditTeamRoomAction extends CloupiaPageAction {
	// need to provide a unique string to identify this form and action
	private static final String FORM_ID = "com.cisco.ukidcv.spark.reports.teams.drilldowns.actions.EditRoomForm";
	private static final String ACTION_ID = "com.cisco.ukidcv.spark.reports.teams.drilldowns.actions.EditRoomAction";
	private static final String LABEL = SparkConstants.EDIT_ROOM_TASK_LABEL;
	private static final String DESCRIPTION = SparkConstants.EDIT_ROOM_TASK_LABEL;

	@Override
	public void definePage(Page page, ReportContext context) {
		// Use the same form (config) as the Edit Host custom task
		page.bind(FORM_ID, EditRoomConfig.class);
	}
	...
	public void loadDataToPage(Page page, ReportContext context, WizardSession session) throws Exception {
		...
		EditRoomConfig form = new EditRoomConfig();

		// Pre-populate the room field (it has the same context as the
		// selection):
		form.setRoomName(query);

		// Fill in the current room name in the new name field for convenience
		form.setNewRoomName(query.split(";")[2]);
	...
	public int validatePageData(Page page, ReportContext context, WizardSession session) throws Exception {
		...
		EditRoomConfig config = (EditRoomConfig) obj;
		...
		page.setPageMessage("Room edited OK");
