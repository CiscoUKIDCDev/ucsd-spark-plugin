 ...
 *
 */
public class DeleteRoomAction extends CloupiaPageAction {
	// need to provide a unique string to identify this form and action
	private static final String FORM_ID = "com.cisco.ukidcv.spark.reports.rooms.actions.DeleteRoomForm";
	private static final String ACTION_ID = "com.cisco.ukidcv.spark.reports.rooms.actions.DeleteRoomAction";
